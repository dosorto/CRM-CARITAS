<div class="h-screen w-full flex flex-col px-5">
    <header class="h-max flex justify-between items-center border-b-2 border-accent py-4">
        ...
        <main class="h-full overflow-y-auto w-full p-4">
            <section class="flex justify-between space-x-4 w-full border-b-2 border-accent">
                <article class="w-4/12 border-gray-400 p-2 rounded-lg">
            ...
            <section class="space-x-4 w-full mt-4 border-b-2 border-accent">
                <h1 class="text-xl font-bold">Ingresos de Artículos</h1>
            ...
            <section class="space-x-4 w-full mt-4">
                <h1 class="text-xl font-bold">Salidas de Artículos</h1>
