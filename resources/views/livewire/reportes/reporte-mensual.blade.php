...
<div class="w-full flex justify-end">
    <button onclick="window.print()" type="button" class="text-white bg-[#ad342b] hover:bg-[#ad342b]/90 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2">
        Imprimir Reporte
        </button>
</div>
<div class=" flex justify-center w-full p-4">

    <div class="print-section" style="width: 8.5in; height: 11in; background-color: #fffcf6; font-family: Arial, Helvetica, sans-serif;">
        <!-- Logos -->
   ...
   <!-- Recuadro rojo -->
        ...
        <div style="width: 80%; border-color: #8a2e2e; color: white; " class="fondo border flex items-center p-2">
            <img style="filter: contrast(150%) brightness(90%) drop-shadow(0 0 5px rgba(0, 0, 0, 0.8));" class="h-14" src="{{ asset('imagenes/reportes/icon-corazon.png') }}" alt="">
            <div class="text-center" style="font-size: 14px;">
                <p  >
                    Servicios que se brindan de menera gratuita y temporal <span class="font-semibold">  hospedaje,</span>
                </p>
...
<!-- personas -->
      ...
      <div class="w-full" style="padding-left: 5em; margin-top: 4px; margin-bottom: 7px;">
        <p style="font-size: 13px; color: #583d2b;">Del total de peronas en movilidad, se identificó a 10 grupos familiares.</p>
      </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
            ...
            <div class="grid justify-start items-end" style="padding-bottom: 65px;">
                <div style="font-size: 16px; color: #583d2b;" class="text-center w-96">
                    <p>Durante el mes</p>
                    <span class="font-bold" style="font-size: 17;"> 18 </span> personas fueron identificadas como
                    <p style="font-size: 17px;" class="font-bold">Migrantes en tránsito</p>
                    <p>y <span style="font-size: 17px;" class="font-bold"> 17 con necesidades de protección</span></p>
    ...
    <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
        <div class="flex flex-col text-center items-end p-3">
            <div class="flex flex-col items-center">
                <div class="flex items-center justify-center" style="font-size: 30px; font-weight: 600; background-color: #ad342b; border-radius: 50%; width: 70px; height: 70px; color: #fffcf6;">
                    {{ $total_personas }}
                </div>
