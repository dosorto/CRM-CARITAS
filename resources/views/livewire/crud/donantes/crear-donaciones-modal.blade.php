<div>
    ...
    <div class="modal" role="dialog">
        <div class="modal-box w-2/3 max-w-5xl bg-neutral">
            ...
            <h3 class="text-lg font-bold text-center">Añadir Donante</h3>
            ...
            <main class="h-max flex flex-col w-full">
                ...
                <div class="flex flex-col mt-6">
                    ...
                    <select wire:model="tipo_donante_id" class="select bg-accent">
                        <option value="">Seleccionar tipo de donante</option>
