<div>
    ...
    <div class="modal" role="dialog">
        <div class="modal-box w-2/5 max-w-5xl bg-neutral">
            ...
            {{-- Título del Modal --}}
            <h3 class="text-lg font-bold text-center">Añadir Motivo de Salida del País</h3>
            ...
            <main class="h-max flex flex-col w-full"> 
                ...
                <div class="flex flex-col mt-6"> 
                    <label class="mb-1"> Motivo de Salida del País </label>
                    <input wire:model="Motivo" class="input b g-accent" type="text" placeholder="Escribir aquí..." />
