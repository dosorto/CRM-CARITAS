    ...
    <div class="dark:text-gray-300">
        ...
        <div class="pb-5 flex w-full">
            ...
            <div class="flex justify-end items-center w-2/6">
                ...
                <button wire:click=" $dispatch('openModal', {component: 'crud.sub-categorias.crear-sub-categoria'})"
                ...
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">
                            SubCategorías de Mobiliarios
                        </th>
                        <th scope="col" class="px-6 py-3">
                            Categorías de Mobiliarios
                        </th>
                        <th scope="col" class="px-6 py-3">
                            Acciones
                        </th>
                                    ...
                                    <td class="px-6 py-3 flex gap-2">
                                        <div>
                                            ...
                                            <button type="button" {{-- Con este evento del boton se invoca el modal de Editar --}}
                                                ...
                                                $dispatch(
                                                    'openModal', { 
                                                            component: 'crud.sub-categorias.editar-sub-categoria', 
                                            ...
                                            $dispatch(
                                                'openModal', { 
                                                        component: 'crud.subcategorias.eliminar-sub-categoria', 
                                                        arguments: { id: {{ $item->id }} }}
                                                )"
