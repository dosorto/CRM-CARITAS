        ...
        <form wire:submit.prevent="guardar">
            ...
            <div class="w-full flex items-stretch h-full gap-12">
                ...
                <div class="flex-col h-full w-1/2">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg rounded-lg p-6 h-full">
                ...
                <div class="flex size-full h-full w-1/2">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg rounded-lg p-6 w-full h-full flex flex-col">
                            ...
                            @if ($familiar_seleccionado)
                                ...
                                <div class="flex mt-6 justify-center">
                                    <button type="button" wire:click="limpiarFamiliar"
                                        class="dark:bg-gray-700 dark:hover:bg-gray-600 text-white py-2 px-5 rounded">Seleccionar
                                        Otro Familiar</button>
                                </div>

                                <div class="flex mt-6 justify-center">
                                    <button type="submit"
                                        class="dark:bg-green-800 dark:hover:bg-green-700 text-white py-2 px-5 rounded">Guardar</button>
                                </div>
                            @else
                                {{-- Tabla de Búsqueda --}}
                        ...
                        @else
                            ...
                            <div class="flex mt-6 justify-center">
                                <button type="button" wire:click="generarNuevoCodigoFamiliar"
                                    class="dark:bg-blue-800 dark:hover:bg-blue-700 text-white py-2 px-5 rounded">Generar
                                    Nuevo Código</button>
                            </div>
