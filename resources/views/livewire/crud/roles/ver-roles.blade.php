<div>
    <div class="dark:text-gray-300">
        ...
        <div class="flex relative overflow-x-auto shadow-md sm:rounded-lg mb-4">
            {{-- Buscador Dinamico --}}
            <div class="flex w-4/6">
                ...
                <div class="relative w-3/12">
                    <p
                        class="border border-gray-300 text-sm rounded-s-lg border-s-gray-100 dark:border-s-gray-700 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        Rol
                    </p>
                </div>
            ...
            <div class="flex justify-end items-center w-2/6">
                <button wire:click=" $dispatch('openModal', {component: 'crud.roles.crear-role'})"
                                    ...
                                    <div>
                                        ...
                                        <button type="button" {{-- Con este evento del boton se invoca el modal de Editar --}}
                                            wire:click="
                                                $dispatch(
                                                    'openModal', {
                                                            component: 'crud.roles.editar-role',
                                                            arguments: { id: {{ $item->id }} }}
                                                    )"
                                        ...
                                        <button type="button"
                                            ...
                                            $dispatch(
                                                'openModal', {
                                                        component: 'crud.roles.eliminar-role',
                                                        arguments: { id: {{ $item->id }} }}
                                                )"
