    ...
    <div class="dark:text-gray-300">
        ...
        <div class="w-full flex justify-center mb-6">
            <h1 class="text-2xl font-bold">
                Listado de Faltas Disciplinariaas
            </h1>
        </div>


        {{-- Contenedor justo encima de la tabla --}}
        <div class="pb-5 bg-white dark:bg-gray-900 flex w-full">
            ...
            <div class="flex w-4/6">
                ...
                <form class="flex w-full" wire:submit="buscar">
                    ...
                    <div class="relative w-[50px]">
                        <button type="submit"
                            class="disabled flex justify-center items-center h-full w-full rounded-e-lg hover:bg-gray-300 bg-gray-200 border border-gray-300 text-gray-900 text-sm border-s-gray-100 dark:border-s-gray-700 focus:ring-blue-500 focus:border-blue-500 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="flex justify-end items-center w-2/6">
                ...
                <button wire:click="$dispatch('openModal', {component: 'crud.faltas.crear-falta'})"
                        ...
                        @foreach ($datos as $item)
                            <div wire:key="{{ $item->id }}">
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-3">
                                        {{ $item->falta_disciplinaria }}
                                    </td>
                                    <td class="px-6 py-3">
                                        {{ $item->gravedadFalta->gravedad_falta }}
                                    </td>
                                    ...
                                    <td class="px-6 py-3 flex gap-2">
                                        <div>
                                            ...
                                            <button type="button" {{-- Con este evento del boton se invoca el modal de Editar --}}
                                                ...
                                                $dispatch(
                                                    'openModal', { 
                                                            component: 'crud.gravedad-faltas.editar-gravedad-faltas', 
