                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li class="absolute bottom-0 w-full">
                        <button id="theme-toggle" type="button"
                            class="mb-4 text-red-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
