<div class="w-full flex justify-center">
    <div class="relative p-4 w-full max-w-4xl max-h-full"> <!-- Cambié max-w-2xl a max-w-4xl -->
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" wire:click="toUsuarios()"
                ...
                <form class="max-w-sm mx-auto">
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        <input wire:model="email" type="email" id="email-address-icon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@flowbite.com">
                      </div>
                      <p class="text-red-600 font-semibold italic">
                        @error('email')
                        {{ $message }}
            ...
            <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button data-modal-hide="default-modal" type="button" wire:click.prevent="edit()"
                ...
                <button data-modal-hide="default-modal" type="button" wire:click="toUsuarios()"
