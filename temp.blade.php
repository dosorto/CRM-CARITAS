        ...
        <div class="text-lg">
            ...
            <div class="w-full flex gap-12 mb-6">
                ...
                <div class="w-1/2 size-max flex items-center gap-16 justify-center">
                    ...
                    <div class="flex-col">
                        {{-- Sexo --}}
                        <label class="flex justify-cernter mb-2 font-medium text-gray-900 dark:text-gray-300">
                            Sexo
                        </label>
                        <div class="flex items-center h-full pt-2">
                            <input type="radio" id="sexo_m" value="M" wire:model="datosPersonales.sexo"
                            ...
                            <label for="sexo_m" class="ml-1 font-medium text-gray-900 dark:text-gray-300">M</label>

                            <input type="radio" id="sexo_f" value="F" wire:model="datosPersonales.sexo"
                            ...
                            <label for="sexo_f" class="ml-1 font-medium text-gray-900 dark:text-gray-300">F</label>
                        </div>
                    </div>
                    <div class="flex-col">
                        <!-- LGBT Checkbox -->
                                        ...
                                        @foreach ($migrantes_filtrados as $migrante)
                                            <tr class="bg-white border-b dark:bg-slate-800 dark:border-gray-700">
                                                ...
                                                <td class="px-2 py-2">
                                                    ...
                                                    <button type="button" title="Seleccionar Como Familiar"
